...
// FindDiskPathOfImport maps an import path (e.g. "github.com/SkycoinProject/skycoin/src/coin") to a path on disk,
...
func BuildStructEncoder(s *StructInfo, destPackage, fmtFilename string, exported bool) ([]byte, error) {
	...
	pkgHeader := fmt.Sprintf("// Code generated by github.com/SkycoinProject/skyencoder. DO NOT EDIT.\npackage %s\n\n", pkgName)
...
func mapTypeName(t *types.Map, p *types.Package) string {
	...
	// map[int32]coin.UxOut will return "map[int32]github.com/SkycoinProject/skycoin/src/coin.UxOut"
